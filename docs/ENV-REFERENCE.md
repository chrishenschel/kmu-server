...
| Variable | Set by | Description |
|----------|--------|-------------|
| `PG_PASS` | Setup | Password for PostgreSQL superuser `postgres`. Used by Authentik, Synapse, Stalwart, Nextcloud, Immich, Paperless. |
...
| `NOREPLY_MAIL_PASSWORD` | Setup | Password for `noreply@…` mailbox in Stalwart. |
